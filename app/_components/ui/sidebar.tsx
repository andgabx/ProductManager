  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-primary-dark font-medium dark:text-neutral-200 text-md group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {link.label}
      </motion.span>
